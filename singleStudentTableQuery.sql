...
VALUES ('100000', 'Joe', 'Cooper', '01 Main', 'Phila', 'PA', '19122', '2154445555', 'Comp Science', '3.6', 'M', False);

INSERT INTO Student
(snum, firstname, lastname, street, city, st, zip, phone, major, gpa, gender, scholarship)
VALUES ('J11233', 'Mauris', 'Cholaro', '63 Woodland', 'Phila', 'PA', '19142', '2671295460', 'Accounting', '2.9', 'M',
        TRUE);

INSERT INTO Student
(snum, firstname, lastname, street, city, st, zip, phone, major, gpa, gender, scholarship)
VALUES ('J85147', 'Michael', 'Bentt', '22 Le Bronx', 'New York', 'NY', '19801', '6105290071', 'Business Admin', '4.0',
        'M', TRUE);
...
INSERT INTO Student
(snum, firstname, lastname, street, city, st, zip, phone, major, gpa, gender, scholarship)
VALUES ('Z61403', 'Kwame', 'Traylor', '37 Have Hill', 'Conshohoken', 'PA', '19341', '2157308912', 'Biology', '3.3', 'F',
        TRUE);

INSERT INTO Student
(snum, firstname, lastname, street, city, st, zip, phone, major, gpa, gender, scholarship)
VALUES ('Z45503', 'Stephanie', 'Cowdery', '45 Bule Lane', 'Newark', 'DE', '18677', '3025678944', 'Law', '3.3', 'F',
        TRUE);
...
INSERT INTO Student
(snum, firstname, lastname, street, city, st, zip, phone, major, gpa, gender, scholarship)
VALUES ('Z64585', 'Jennifer', 'Thompson', '202 Park Avenue', 'New Castle', 'DE', '87933', '6092344567', 'CIS', '3.5', 'F', True);
...
SELECT snum, firstname, lastname, phone
FROM Student
WHERE zip = 18677 AND scholarship = True;